          ...
          <div className="bg-white border border-amber-900/10 rounded-2xl p-6 sm:p-8 shadow-xs space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-slate-100">
              ...
              <div className="bg-amber-50/60 p-4 rounded-xl border border-amber-200/40 space-y-1.5">
                <h4 className="font-bold text-amber-950 text-sm flex items-center space-x-1.5">
                  <span className="w-2 h-2 rounded-full bg-amber-600"></span>
                  <span>{lang === 'hi' ? 'प्लेगेरिज्म (Plagiarism)' : 'Plagiarism Threshold'}</span>
                </h4>
                <p className="text-xs text-slate-600 leading-relaxed">
                  {lang === 'hi' 
                    ? '10% से कम समरूपता (Plagiarism < 10%) होना अनिवार्य है।' 
                    : 'Must be below 10% similarity index.'}
                </p>
              </div>
              ...
              <div className="bg-amber-50/60 p-4 rounded-xl border border-amber-200/40 space-y-1.5">
                <h4 className="font-bold text-amber-950 text-sm flex items-center space-x-1.5">
                  <span className="w-2 h-2 rounded-full bg-amber-600"></span>
                  <span>{lang === 'hi' ? 'सन्दर्भ शैली (References)' : 'Citation Style'}</span>
                </h4>
                <p className="text-xs text-slate-600 leading-relaxed">
                  {lang === 'hi' 
                    ? 'APA (American Psychological Association) 7th Edition शैली।' 
          ...
          <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200 shadow-xs">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="font-serif font-bold text-lg text-slate-900">
                {lang === 'hi' ? 'नैतिकता एवं समीक्षा' : 'Ethics & Review'}
              </h3>
            </div>
            <div className="space-y-4 text-sm text-slate-600">
              <p>
                {lang === 'hi' 
                  ...
                  : 'The journal follows a double-blind peer review process. All submitted manuscripts are reviewed by at least 2 subject experts.'}
              </p>
